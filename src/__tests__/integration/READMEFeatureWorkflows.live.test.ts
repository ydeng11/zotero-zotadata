...
describeLive('README live workflows', () => {
  ...
  it(
    'updates metadata for the Gibbs article using live DOI services',
    async (context) => {
  ...
  it(
    'does not corrupt an unrelated title when given the supplied mismatched DOI',
    async (context) => {
      await withTransientSkip(context, async () => {
        const preflight = await new CrossRefAPI().getCrossRefWorkMessage(
  ...
  it(
    'corrects the Semi-Supervised arXiv DOI using live metadata fetch',
    async (context) => {
      await withTransientSkip(context, async () => {
  ...
  it(
    'retrieves the Semi-Supervised arXiv PDF even with a mismatched DOI',
    async (context) => {
      await withTransientSkip(context, async () => {
        const item = createMockZoteroItem({
          ...PUBLICATIONS.semiSupervisedLearning,
  ...
  it(
    'falls back to preprint conversion when no published version is found for InfoGAN',
    async (context) => {
      await withTransientSkip(context, async () => {
        const item = createMockZoteroItem({
  ...
  it(
    'retrieves a real PDF for Dynamic Word Embeddings when none exists',
    async (context) => {
      await withTransientSkip(context, async () => {
        const item = createMockZoteroItem({
