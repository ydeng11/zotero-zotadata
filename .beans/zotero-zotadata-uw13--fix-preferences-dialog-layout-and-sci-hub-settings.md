...
- Verification: npm test -- --run src/**tests**/unit/PreferencesDialogAssets.test.ts passed. npm run build packaged successfully but tsc --noEmit still fails on the pre-existing syntax error in src/**tests**/unit/SciHubService.test.ts:230.
