...
export declare function registerFixture(urlPattern: string | RegExp, response: MockResponse): void;
...
export declare function createMockHTTP(): {
    request: import("vitest").Mock<[method: string, url: string, _options?: any], Promise<MockResponse>>;
};
