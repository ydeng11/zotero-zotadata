...
describe("API Clients", () => {
  ...
  describe("searchOpenAlexTitleOnly", () => {
    ...
    beforeEach(() => {
      searchOpenAlexTitleOnly = createZotadataMethod(
        "searchOpenAlexTitleOnly",
        {
          titleSimilarity: createZotadataMethod("titleSimilarity"),
        },
      );
  ...
  describe("searchSemanticScholarForDOI", () => {
    ...
    beforeEach(() => {
      searchSemanticScholarForDOI = createZotadataMethod(
        "searchSemanticScholarForDOI",
        {
          titleSimilarity: createZotadataMethod("titleSimilarity"),
          searchSemanticScholarExact: createZotadataMethod(
            "searchSemanticScholarExact",
            {
              titleSimilarity: createZotadataMethod("titleSimilarity"),
            },
          ),
          searchSemanticScholarRelaxed: createZotadataMethod(
            "searchSemanticScholarRelaxed",
            {
              titleSimilarity: createZotadataMethod("titleSimilarity"),
            },
          ),
    ...
    it("should find DOI from Semantic Scholar", async () => {
      const { semanticscholarFixtures } =
        await import("../../__mocks__/fixtures/semanticscholar");
      registerFixture(
  ...
  describe("searchCrossRefForPublishedVersion", () => {
    ...
    beforeEach(() => {
      searchCrossRefForPublishedVersion = createZotadataMethod(
